export default {
    ...
    testimonials: [
      {
        ...
        name: 'Eric Bonvin',
        title: 'Leiter der Walliser Spitäler',
      },
      {
        quote:
  ...
  mission: {
    ...
    enSavoirPlus: {
      ...
      vd: '> Erfahren Sie mehr über den Waadtländer Verein',
      ge: '> Erfahren Sie mehr über den Genfer Verein',
    },
    buts: {
      title: 'Unsere Ziele',
      content: [
    ...
    objectifs: {
      ...
      content: [
        ...
        },
        {
          ...
          text: 'Jedes Konzert ist Teil eines Vermittlungsprozesses, der den Zugang zur Kultur erleichtert: Einerseits wird jedes Konzert dem Kontext und Besonderheit des Ortes und des Publikums anpasst, andererseits werden jeweils Publikums verbindende Elemente wie beispielsweise die Einbindung regionaler Volkslieder integriert.',
        },
        {
