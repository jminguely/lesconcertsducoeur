      ...
      <div class="flex-grow lg:w-2/5">
        <div class="ml-auto">
          <template v-if="selected.picture != null">
            <img class="object-cover h-full lg:w-120 lg:h-full w-96" :src="'https://cdc-backend.minguely.ch' + selected.picture.url" />
          </template>
          <template v-if="selected.cover != null">
            <img class="object-cover h-full lg:w-120 lg:h-full w-96" :src="'https://cdc-backend.minguely.ch' + selected.cover.url" />
          </template>
        </div>
