<template>
  <div class="py-5 border-b border-black">
    ...
    <div
      class="duration-300 ease-in-out min-h-0 max-h-0 flex flex-col lg:flex-row justify-between"
      :class="{ 'opacity-0 overflow-hidden max-h-0 font-newsCycle': !open, 'opacity-1 max-h-144 overflow-visible pt-4': open }"
    >
      <div class="w-full pr-5 text-2xl">
